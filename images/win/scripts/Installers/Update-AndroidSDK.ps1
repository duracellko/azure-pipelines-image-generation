...
if(Test-Path $ndk_root){
	...
	# Download Android NDK r19b
	Invoke-WebRequest -UseBasicParsing -Uri "https://dl.google.com/android/repository/android-ndk-r19b-windows-x86_64.zip" -OutFile android-ndk-r19b-windows-x86_64.zip
	Expand-Archive -Path android-ndk-r19b-windows-x86_64.zip -DestinationPath $ndk_root
